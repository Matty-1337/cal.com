...
import { DKDatePills } from "./dk-overrides/DKDatePills";
        ...
        <div
          ...
          <AnimatePresence>
            ...
            <BookerSection
              ...
              {/* DK-CUSTOM: Use date pills for short rolling windows when DK theme is active */}
              {customClassNames?.bookerWrapper?.includes("dk-booking") &&
              event?.data?.periodType === "ROLLING" &&
              event?.data?.periodDays != null &&
              event.data.periodDays <= 3 ? (
                <DKDatePills />
              ) : (
                <DatePicker
                  classNames={customClassNames?.datePickerCustomClassNames}
